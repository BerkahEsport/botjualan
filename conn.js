...
const isOwner = [`${setting.ownerNumber}`,"62895371549895@s.whatsapp.net","62895371549895@s.whatsapp.net"].includes(sender) ? true : false
...
"fileName": `Ikhsan-BOT ${ngazap(prefix)}`,
...
const gurbot = '62895371549895@s.whatsapp.net'
...
var bg_lexxy = '62895371549895@s.whatsapp.net'
...
conn.sendMessage(from, { caption: cap, image: { url: feta.data.qris }, buttons: buto, footer: '© created by @moexti' })
}
console.log(feta)
}
break
